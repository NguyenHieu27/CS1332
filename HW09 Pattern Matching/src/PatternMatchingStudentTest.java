...
public class PatternMatchingStudentTest {
    ...
    // EXTRA BASIC TESTS FOR BOYER-MOORE GALIL RULE

    @Test(timeout = TIMEOUT)
    public void testBoyerMooreGalilMatch() {
        /*
            pattern: sell
            text: She sells seashells by the seashore.
            indices: 4
    ...
    @Test(timeout = TIMEOUT)
    public void testBoyerMooreGalilNoMatch() {
        /*
            pattern: sell
            text: sea lions trains cardinal boardwalk
            indices: -
         ...
         */
        assertEquals(emptyList,
                PatternMatching.boyerMooreGalilRule(sellPattern,
                        sellNoMatch, comparator));
        assertTrue("Did not use the comparator.",
                comparator.getComparisonCount() != 0);
        assertEquals("Comparison count was " + comparator.getComparisonCount()
    ...
    @Test(timeout = TIMEOUT)
    public void testBoyerMooreGalilMultipleMatches() {
        /*
            pattern: ab
            text: abab
            indices: 0, 2
         ...
         */
        assertEquals(multipleAnswer,
                PatternMatching.boyerMooreGalilRule(multiplePattern,
                        multipleText, comparator));
        assertTrue("Did not use the comparator.",
                comparator.getComparisonCount() != 0);
        assertEquals("Comparison count was " + comparator.getComparisonCount()
    ...
    @Test(timeout = TIMEOUT)
    public void testBoyerMooreGalilLongerText() {
        /*
            pattern: sea lions trains cardinal boardwalk
            text: sell
            indices: -
